...
- Prior-art landscape: the 2026-08-09 operator-side survey found the niche's closest competitors chose Ed25519 signatures; this ADR's reasoning (whoever holds the key can rewrite and re-sign; anchoring binds history to something nobody holds) must therefore surface in the README, not only here.
- Glossary terms **added or sharpened**: `docs/GLOSSARY.md` — *hash chain*, *chain head*, *tamper-evident*, *anchor*, *canonical form*.
- Glossary terms **retired**, and topologies overruled: none — first ADR of the repo.
- Discussion: design conversation, 2026-08-09.
